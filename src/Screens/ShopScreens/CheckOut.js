...
const CheckOut = (item) => {
  ...
  const { API_Shop, CheckoutDetail, ConfirmOrderData } =
  ...
  const data =
    (CheckoutDetail &&
      Array.isArray(CheckoutDetail?.data) &&
      CheckoutDetail?.data) ||
    [];
  const newData =
    (CheckoutDetail &&
      Array.isArray(CheckoutDetail?.data?.result) &&
      CheckoutDetail?.data?.result) ||
    [];
      ...
      <ScrollView>
        <View style={{ padding: 20 }}>
          ...
          <View elevation={1} style={styles.addressView}>
            ...
            >
              <Text
                style={{ fontSize: 12, fontWeight: "400", color: "#56AB2F" }}
              >
          ...
          <View
            style={[styles.outline, { height: 10, marginBottom: 7 }]}
          ></View>
          <Text
            style={{
              color: "#424347",
